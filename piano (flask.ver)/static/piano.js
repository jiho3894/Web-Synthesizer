const C4 = new Audio("static/sounds/C4.mp3");
const Db4 = new Audio("static/sounds/Db4.mp3");
const D4 = new Audio("static/sounds/D4.mp3");
const Eb4 = new Audio("static/sounds/Eb4.mp3");
const E4 = new Audio("static/sounds/E4.mp3");
const F4 = new Audio("static/sounds/F4.mp3");
const Gb4 = new Audio("static/sounds/Gb4.mp3");
const G4 = new Audio("static/sounds/G4.mp3");
const Ab4 = new Audio("static/sounds/Ab4.mp3");
const A4 = new Audio("static/sounds/A4.mp3");
const Bb4 = new Audio("static/sounds/Bb4.mp3");
const B4 = new Audio("static/sounds/B4.mp3");
const C5 = new Audio("static/sounds/C5.mp3");
const Db5 = new Audio("static/sounds/Db5.mp3");
const D5 = new Audio("static/sounds/D5.mp3");
const Eb5 = new Audio("static/sounds/Eb5.mp3");
const E5 = new Audio("static/sounds/E5.mp3");
...
const playSound = audio => {
  ...
  setTimeout(() => (clone.volume = 0), 1500);
};
