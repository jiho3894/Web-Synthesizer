const A1 = new Audio("drums/A1.mp3");
const W2 = new Audio("drums/W2.mp3");
const S3 = new Audio("drums/S3.mp3");
const E4 = new Audio("drums/E4.mp3");
const U5 = new Audio("drums/U5.mp3");
const K6 = new Audio("drums/K6.mp3");
const F7 = new Audio("drums/F7.mp3");
const O8 = new Audio("drums/O8.mp3");
